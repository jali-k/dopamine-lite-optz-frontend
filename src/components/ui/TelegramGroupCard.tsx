      ...
      >
        <Flex alignItems="center" width="100%" justifyContent="center">
          ...
          <VStack alignItems="flex-start"> {/* Align text to the left */}
            <Text fontSize="1.25rem" fontWeight="bold" color={Light.black100} fontFamily={fontFamily}> 
              2026 Theory Class
            </Text>
        ...
        <Text fontSize="1rem" color={Light.black100} textAlign="center" mt="0.0625rem">
          Join for daily updates and discussions on theory topics
        </Text>
        <Button color={Light.white100} size="md" fontSize="1.125rem" width="100%" bg={Light.darkGreen} height="2.625rem" maxWidth="9.125rem" borderRadius="2.5rem" mt="0.1875rem"> 
          Join Group
        </Button>
      </VStack>
    </Box>
